...
function App() {
  ...
  useEffect(() => {
    ...
    useEffect(()=>{
      if(counter === 0){
      setYazi("IYI SENELEEEER")}}, [counter]);
      
    return <div className="App">
    
    <div style={{width:"200px",height:"200px",borderRadius:"50%",backgroundColor:"blueviolet",color:"white",margin:"0 auto",lineHeight:"200px"}}>
      <h1>{counter}</h1>
